# -*- coding: utf-8 -*-
"""
Created on Sun Apr 20 10:45:01 2025
...
#Input fields
sepal_length = st.slider("Sepal Length (cm)",4,0,8,5.1)
sepal_width = st.slider("Sepal Width  (cm)",2,0,4.5,3.5)
petal_length = st.slider("Petal Length (cm)",1,7,1.4)
petal_width = st.slider("Sepal width (cm)",0.1,2.5,0.2)
